open module net.minecraftforge.lowcodelanguage {
    ...
    exports net.minecraftforge.fml.lowcodemod;
    
    provides net.minecraftforge.forgespi.language.IModLanguageProvider
        with net.minecraftforge.fml.lowcodemod.LowCodeModLanguageProvider;
}