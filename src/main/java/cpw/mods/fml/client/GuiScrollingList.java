...
//        boxRight = this.listWidth / 2 - 92 - 16;
    ...
    private void overlayBackground(int p_22239_1_, int p_22239_2_, int p_22239_3_, int p_22239_4_) {
        ...
        var5.addVertexWithUV((double) this.listWidth + 30, p_22239_2_, 0.0D, (float) (this.listWidth + 30) / var6, (float) p_22239_2_ / var6);
        var5.setColorRGBA_I(4210752, p_22239_3_);
        var5.addVertexWithUV((double) this.listWidth + 30, p_22239_1_, 0.0D, (float) (this.listWidth + 30) / var6, (float) p_22239_1_ / var6);
