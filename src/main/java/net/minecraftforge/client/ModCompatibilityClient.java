...
import net.minecraftforge.repackage.paulscode.sound.codecs.CodecIBXM;
...
public class ModCompatibilityClient {
     ...
     */
    private static void audioModWalkFolder(File base, File folder, SoundPool pool) {
    ...
    public static Object mlmpVehicleSpawn(int type, World world, double x, double y, double z, Entity thrower, Object currentEntity) throws Exception {
        ...
        Object ret = entityClass.getConstructor(World.class, Double.TYPE, Double.TYPE, Double.TYPE).newInstance(world, x, y, z);
