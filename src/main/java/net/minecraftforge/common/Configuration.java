...
public class Configuration {
    ...
    public Configuration(File file) {
        this.file = file;
        String basePath = ((File) (FMLInjectionData.data()[3])).getAbsolutePath().replace(File.separatorChar, '/').replace("/.", "");
                        ...
                        if (Character.isLetterOrDigit(line.charAt(i)) || ALLOWED_CHARS.indexOf(line.charAt(i)) != -1 || (quoted && line.charAt(i) != '"')) {
                            ...
                            switch (line.charAt(i)) {
                                ...
                                case '>':
                                    ...
                                    currentCat.set(name, new Property(name, tmpList.toArray(new String[0]), type));
                                    name = null;
                                    tmpList = null;
                                    type = null;
                                    break;
